    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-transparent text-slate-900">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black tracking-tight text-slate-900">Sign in to Candidate Portal</h1>
          <p className="text-xs text-slate-500 mt-1 font-normal">Access your AI mock interview session history and scorecards</p>
        </div>
