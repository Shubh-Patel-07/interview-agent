    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-4 relative overflow-hidden bg-grid-pattern">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-slate-500 mt-1 font-medium">Sign in to your AI candidate account</p>
        </div>
        ...
        <div className="glass-card p-8 rounded-3xl border border-slate-200/80 bg-white/90 shadow-xl">
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative px-3 bg-white text-[11px] font-mono text-slate-400 uppercase font-semibold">OR</span>
          </div>

          <button
            onClick={handleDemoLogin}
            type="button"
            className="w-full py-3 rounded-xl bg-blue-50 hover:bg-blue-100 border border-blue-200 text-blue-600 font-bold text-xs flex items-center justify-center gap-2 transition-colors"
          >
            <Sparkles className="w-4 h-4 text-blue-600" />
            1-Click Demo Guest Sign In
          </button>
