      ...
      >
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2.5 mb-4 group">
            ...
            <span className="font-black text-2xl tracking-tight">Steer<span className="gradient-text">Hire</span></span>
          </Link>
          <h1 className="text-2xl font-black tracking-tight">Sign in to Candidate Portal</h1>
          <p className="text-xs text-slate-500 mt-1">Access your AI mock interview session history and scorecards</p>
        </div>

        <div className="glass-card p-8 rounded-3xl border shadow-xl">
          ...
          <div className="mt-6 pt-6 border-t border-slate-200/60 text-center">
            ...
            >
              <Sparkles className="w-3.5 h-3.5 text-blue-600" /> Quick Demo Guest Sign-In
            </button>
