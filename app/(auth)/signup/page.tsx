    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-grid-pattern">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black tracking-tight">Create Candidate Account</h1>
          <p className="text-xs text-slate-500 mt-1">Start unlimited AI technical mock interview practice</p>
        </div>
