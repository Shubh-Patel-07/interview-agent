    ...
    <div className="min-h-screen flex flex-col bg-transparent text-slate-900">
      ...
      <main className="flex-grow max-w-7xl w-full mx-auto px-4 sm:px-8 py-8 space-y-8">
        ...
        <motion.div
          ...
          className="glass-card p-6 sm:p-8 rounded-3xl border border-blue-500/20 bg-white/95 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm"
        >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="glass-card p-6 rounded-3xl border border-slate-200/80 bg-white/95 flex flex-col justify-between space-y-4 shadow-sm"
          >
            <div>
