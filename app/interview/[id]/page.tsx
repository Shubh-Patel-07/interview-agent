  ...
  return (
    <div className="min-h-screen flex flex-col bg-transparent text-slate-900">
      ...
      <main className="flex-grow max-w-4xl w-full mx-auto p-4 sm:p-6 flex flex-col justify-between space-y-6 relative z-10">
        ...
        <div className="flex-grow space-y-6 overflow-y-auto pr-2">
            ...
            >
              ...
              <div
                className={`max-w-2xl p-5 rounded-2xl text-sm leading-relaxed ${
                  msg.role === 'ai'
                    ? 'glass-card border-blue-500/20 text-slate-800 rounded-tl-none shadow-md bg-white/95'
          ...
          {loading && (
            <div className="flex gap-3 items-start">
              ...
              <div className="glass-card p-4 rounded-2xl rounded-tl-none border-blue-500/20 text-xs text-blue-600 font-bold flex items-center gap-2 bg-white/95">
        ...
        <div className="glass-card p-4 rounded-2xl border border-slate-200/80 bg-white/95 relative shadow-sm">
