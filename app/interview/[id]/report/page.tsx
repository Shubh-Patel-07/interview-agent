...
export default function InterviewReportPage() {
  ...
  if (!report) {
    return (
      <div className="min-h-screen bg-transparent flex items-center justify-center text-slate-900">
      ...
      <main className="flex-grow max-w-5xl w-full mx-auto px-4 sm:px-8 py-10 space-y-8">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl glass-card glass-card-hover border border-slate-200/80 text-xs font-bold text-slate-700 flex items-center gap-2 bg-white/95"
          >
        ...
        {/* Header Hero Banner */}
        <div className="glass-card p-8 rounded-3xl border border-blue-500/20 bg-white/95 relative overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          <div className="glass-card p-5 rounded-3xl border border-blue-500/30 bg-white/95 text-center flex flex-col items-center justify-center shadow-sm">
            <ScoreRing score={report.overall_score} size={110} strokeWidth={8} />
          </div>
          <div className="glass-card p-5 rounded-3xl border border-slate-200/80 bg-white/95 text-center flex flex-col items-center justify-center shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Strengths */}
          <div className="glass-card p-6 rounded-3xl border border-emerald-200 bg-white/95 shadow-sm">
          ...
          {/* Weaknesses */}
          <div className="glass-card p-6 rounded-3xl border border-rose-200 bg-white/95 shadow-sm">
          ...
          {/* Improvements */}
          <div className="glass-card p-6 rounded-3xl border border-amber-200 bg-white/95 shadow-sm">
