...
export function DashboardHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 px-4 sm:px-8 pt-3 pb-2 bg-[#f8fafc]">
      <div className="max-w-7xl mx-auto rounded-2xl bg-white/90 backdrop-blur-xl border border-slate-200/80 px-6 py-3 flex items-center justify-between shadow-sm">
        {/* Brand */}
