      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          {STEPS.map((step, index) => {
            ...
            return (
              <div key={index} className="relative glass-card glass-card-hover p-8 rounded-3xl border border-slate-200/80 bg-white/95 flex flex-col justify-between shadow-sm">
                <div>
