    ...
    <section className="py-20 relative overflow-hidden bg-[#f8fafc]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="glass-card p-10 sm:p-16 rounded-3xl border border-blue-500/20 bg-white relative overflow-hidden shadow-xl">
          ...
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 text-blue-600 border border-blue-200 text-xs font-bold uppercase tracking-wider mb-6">
