...
export function CTA() {
  return (
    <section className="py-20 relative overflow-hidden text-slate-900 dark:text-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="glass-card p-10 sm:p-16 rounded-3xl border border-blue-500/20 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 relative overflow-hidden shadow-xl">
          <div className="glow-blue -top-20 left-1/2 -translate-x-1/2 opacity-30 blur-3xl pointer-events-none" />
          
          <span className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 text-xs font-bold uppercase tracking-wider mb-6">
          ...
          <p className="mt-4 text-slate-500 dark:text-slate-400 text-base sm:text-lg max-w-2xl mx-auto font-normal">
