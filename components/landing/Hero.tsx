...
import { ArrowRight, Sparkles, CheckCircle2, Play, Cpu, Code, Layers, Database, Bot } from 'lucide-react';
  ...
  return (
    <section className="relative pt-28 pb-20 md:pt-36 md:pb-28 overflow-hidden bg-grid-pattern bg-[#05070d] text-slate-100">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-xs text-indigo-300 shadow-md shadow-indigo-500/5 mb-6 backdrop-blur-md">
