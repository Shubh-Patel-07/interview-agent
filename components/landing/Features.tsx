...
const FEATURES = [
  ...
  {
    icon: <Mic className="w-7 h-7 text-emerald-600 dark:text-emerald-400" />,
  ...
  {
    icon: <BarChart3 className="w-7 h-7 text-amber-600 dark:text-amber-400" />,
  ...
  {
    icon: <Award className="w-7 h-7 text-rose-600 dark:text-rose-400" />,
...
export function Features() {
  return (
    <section id="features" className="py-24 relative text-slate-900 dark:text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 border border-blue-200 dark:border-blue-800 text-xs font-bold uppercase tracking-wider mb-4">
            <Sparkles className="w-3.5 h-3.5 text-blue-600 dark:text-blue-400" /> Bento Capability Matrix
          </div>
